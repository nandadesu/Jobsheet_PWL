        ...
        <div class="col-md-6">
            ...
            <?php if(empty($mahasiswa)):?>
                <div class="alert alert-danger" role="alert">
                    Data mahasiswa tida ditemukan</div>
            <?php endif;?>
            <ul class="list-group">
                <?php foreach($mahasiswa as $mhs):?>
                    <li class="list-group-item">
                        <?= $mhs['nama'];?>
                    <a href="<?= base_url();?>mahasiswa/hapus/<?= $mhs['id_mhs'];?>"
                    class="badge badge-danger float-right"
                    onclick="return confirm('yakin data ini mau di hapus');">Hapus</a>

                    <a href="<?= base_url();?>mahasiswa/edit/<?= $mhs['id_mhs'];?>"
